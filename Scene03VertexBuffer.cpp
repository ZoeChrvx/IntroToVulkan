...
void Scene03TriangleVertexBuffer::Load(Renderer& renderer) {
	...
	transferData[0] = PositionColorVertex{ -0.5, 0.5, 0, 255, 153, 255, 255 };
	transferData[1] = PositionColorVertex{ -0.5, -0.5, 0, 255, 178, 102, 255 };
	transferData[2] = PositionColorVertex{ 0.5, -0.5, 0, 153, 255, 153, 255 };
	transferData[3] = PositionColorVertex{ -0.5, 0.5, 0, 255, 153, 255, 255 };
	transferData[4] = PositionColorVertex{ 0.5, 0.5, 0, 143, 204, 255, 255 };
	transferData[5] = PositionColorVertex{ 0.5, -0.5, 0, 153, 255, 153, 255 };
